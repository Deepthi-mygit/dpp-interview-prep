# Terraform & Infrastructure — Interview Questions

> All answers grounded in the zen-infra project (Terraform 1.10, AWS EKS 1.33, RDS PostgreSQL 15.7, S3 state backend).
> 45 questions across fundamentals, state management, modules, CI/CD, and real scenarios.

---

## Table of Contents

1. [Core Concepts](#1-core-concepts) (Q1–Q12)
2. [State & Backend](#2-state--backend) (Q13–Q19)
3. [Modules & Code Structure](#3-modules--code-structure) (Q20–Q24)
4. [CI/CD & Team Workflows](#4-cicd--team-workflows) (Q25–Q29)
5. [Scenario-Based](#5-scenario-based) (Q30–Q40)
6. [Zen-Infra Real Scenarios](#6-zen-infra-real-scenarios) (Q41–Q45)
...
## Section 6 — Zen-Infra Real Scenarios

### Q41. You need to add a 9th microservice called `reporting-service` to the platform. Walk me through every file you would change and what would happen when you run the pipeline.
...
### Q43. Your `terraform apply` fails halfway through. EKS was created but RDS failed. What happens to the state file? What do you do next?
...
### Q44. Explain what happens when you change a module output. For example, you rename `private_eks_subnet_ids` to `eks_subnet_ids` in `modules/vpc/outputs.tf`. Where will `terraform plan` fail and why?
...
### Q45. A `terraform plan` on the `modules/rds` module shows that the RDS instance will be **destroyed and recreated** — even though you only changed `backup_retention_period` from 0 to 7. Why could this happen and is it safe to apply?
